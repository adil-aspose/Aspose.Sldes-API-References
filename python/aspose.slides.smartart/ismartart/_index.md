...
type: docs
weight: 10
url: /python/aspose.slides.smartart/ismartart/
---
...
|**Name**|**Description**|
| :- | :- |
|all_nodes|Returns collections of all nodes in SmartArt object.<br/>            Read-only [ISmartArtNodeCollection](/python/aspose.slides.smartart/ismartartnodecollection/).|
...
|layout|Return or set layout of the SmartArt object.<br/>            Read/write [SmartArtLayoutType](/python/aspose.slides.smartart/smartartlayouttype/).|
|quick_style|Return or set quick style of the SmartArt object.<br/>            Read/write [SmartArtQuickStyleType](/python/aspose.slides.smartart/smartartquickstyletype/).|
|color_style|Return or set color style of the SmartArt object.<br/>            Read/write [SmartArtColorType](/python/aspose.slides.smartart/smartartcolortype/).|
