...
type: docs
weight: 60
url: /python/aspose.slides.smartart/smartart/
---
...
|all_nodes|Returns collections of all nodes in the SmartArt object.<br/>            Read-only [ISmartArtNodeCollection](/python/aspose.slides.smartart/ismartartnodecollection/).|
|nodes|Returns collections of root nodes in SmartArt object.<br/>            Read-only [ISmartArtNodeCollection](/python/aspose.slides.smartart/ismartartnodecollection/).|
|layout|Returns or sets layout of the SmartArt object.<br/>            Read/write [SmartArtLayoutType](/python/aspose.slides.smartart/smartartlayouttype/).|
|quick_style|Returns or sets quick style of SmartArt object.<br/>            Read/write [SmartArtQuickStyleType](/python/aspose.slides.smartart/smartartquickstyletype/).|
|color_style|Returns or sets color style of SmartArt object.<br/>            Read/write [SmartArtColorType](/python/aspose.slides.smartart/smartartcolortype/).|
