...
type: docs
weight: 1900
url: /python/aspose.slides/imasterslidecollection/
---
...
|**Name**|**Description**|
| :- | :- |
|[index]|Gets the element at the specified index.<br/>            Read-only [IMasterSlide](/python/aspose.slides/imasterslide/).|
## **Methods**
|**Name**|**Description**|
| :- | :- |
