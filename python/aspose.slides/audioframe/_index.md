...
type: docs
weight: 50
url: /python/aspose.slides/audioframe/
---
...
|shape_lock|Returns shape's locks.<br/>            Read-only [IPictureFrameLock](/python/aspose.slides/ipictureframelock/).|
...
|picture_frame_lock|Returns shape's locks.<br/>            Read-only [IPictureFrameLock](/python/aspose.slides/ipictureframelock/).|
|picture_format|Returns the PictureFillFormat object for a picture frame.<br/>            Read-only [IPictureFillFormat](/python/aspose.slides/ipicturefillformat/).|
...
|volume|Returns or sets the audio volume.<br/>            Read/write [AudioVolumeMode](/python/aspose.slides/audiovolumemode/).|
|play_mode|Returns or sets the audio play mode.<br/>            Read/write [AudioPlayModePreset](/python/aspose.slides/audioplaymodepreset/).|
...
|embedded_audio|Returns or sets embedded audio object.<br/>            Read/write [IAudio](/python/aspose.slides/iaudio/).|
...
|as_igeometry_shape|Allows to get base IGeometryShape interface.<br/>            Read-only [IGeometryShape](/python/aspose.slides/igeometryshape/).|
|as_ipicture_frame|Allows to get base IPictureFrame interface.<br/>            Read-only [IPictureFrame](/python/aspose.slides/ipictureframe/).|
## **Methods**
|**Name**|**Description**|
| :- | :- |
