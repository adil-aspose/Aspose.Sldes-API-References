...
type: docs
weight: 810
url: /python/aspose.slides/iautoshape/
---
...
|**Name**|**Description**|
| :- | :- |
|shape_lock|Returns shape's locks.<br/>            Read-only [IAutoShapeLock](/python/aspose.slides/iautoshapelock/).|
|auto_shape_lock|Returns AutoShape's locks.<br/>            Read-only [IAutoShapeLock](/python/aspose.slides/iautoshapelock/).|
|text_frame|Returns TextFrameEx object for the AutoShapeEx.<br/>            Read-only [ITextFrame](/python/aspose.slides/itextframe/).|
