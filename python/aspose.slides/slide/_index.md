...
type: docs
weight: 3700
url: /python/aspose.slides/slide/
---
...
|header_footer_manager|Returns HeaderFooter manager of the slide.<br/>            Read-only [ISlideHeaderFooterManager](/python/aspose.slides/islideheaderfootermanager/).|
...
|slide_number|Returns a number of slide.<br/>            Index of slide in [slides](/python/aspose.slides/presentation/) collection is always equal to SlideNumber - Presentation.FirstSlideNumber.<br/>            Read/write|
|hidden|Determines whether the specified slide is hidden during a slide show.<br/>            Read/write bool.|
|layout_slide|Returns or sets the layout slide for the current slide.<br/>            Read/write [ILayoutSlide](/python/aspose.slides/ilayoutslide/).|
|notes_slide_manager|Allow to access notes slide, add and remove it.<br/>            Read-only [INotesSlideManager](/python/aspose.slides/inotesslidemanager/).|
