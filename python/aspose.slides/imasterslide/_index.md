...
type: docs
weight: 1890
url: /python/aspose.slides/imasterslide/
---
...
|**Name**|**Description**|
| :- | :- |
|header_footer_manager|Returns HeaderFooter manager of the master slide.<br/>            Read-only [IMasterSlideHeaderFooterManager](/python/aspose.slides/imasterslideheaderfootermanager/).|
|title_style|Returns the style of a title text.<br/>            Read-only [ITextStyle](/python/aspose.slides/itextstyle/).|
|body_style|Returns the style of a body text.<br/>            Read-only [ITextStyle](/python/aspose.slides/itextstyle/).|
|other_style|Returns the style of an other text.<br/>            Read-only [ITextStyle](/python/aspose.slides/itextstyle/).|
|layout_slides|Returns the collection of child layout slides for this master slide.<br/>            Read-only [IMasterLayoutSlideCollection](/python/aspose.slides/imasterlayoutslidecollection/).|
