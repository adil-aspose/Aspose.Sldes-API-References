...
type: docs
weight: 340
url: /python/aspose.slides/connector/
---
...
|shape_lock|Returns shape's locks.<br/>            Read-only [IConnectorLock](/python/aspose.slides/iconnectorlock/).|
...
|shape_type|Returns or sets the AutoShape type.<br/>            Read/write [ShapeType](/python/aspose.slides/shapetype/).|
...
|connector_lock|Returns connector's locks.<br/>            Read-only [IConnectorLock](/python/aspose.slides/iconnectorlock/).|
|start_shape_connected_to|Returns or sets the shape to attach the beginning of the connector to.<br/>            Read/write [IShape](/python/aspose.slides/ishape/).|
|end_shape_connected_to|Returns or sets the shape to attach the end of the connector to.<br/>            Read/write [IShape](/python/aspose.slides/ishape/).|
