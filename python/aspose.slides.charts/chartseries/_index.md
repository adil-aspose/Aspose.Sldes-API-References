...
type: docs
weight: 240
url: /python/aspose.slides.charts/chartseries/
---
...
|parent_series_group|ParentSeriesGroup.<br/>            Read-only [IChartSeriesGroup](/python/aspose.slides.charts/ichartseriesgroup/).|
...
|marker|Marker.<br/>            Read-only [IMarker](/python/aspose.slides.charts/imarker/).|
...
|inverted_solid_fill_color|Specifies invert solid color for series. To apply color setting set series format FillType to FillType.Solid.<br/>            Read/write [ColorFormat](/python/aspose.slides/colorformat/).|
