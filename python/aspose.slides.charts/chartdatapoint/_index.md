...
type: docs
weight: 140
url: /python/aspose.slides.charts/chartdatapoint/
---
...
|**Name**|**Description**|
| :- | :- |
|xvalue|XValue.<br/>            Read-only [IStringOrDoubleChartValue](/python/aspose.slides.charts/istringordoublechartvalue/).|
|yvalue|YValue.<br/>            Read-only [IDoubleChartValue](/python/aspose.slides.charts/idoublechartvalue/).|
|bubble_size|BubbleSize.<br/>            Read-only [IDoubleChartValue](/python/aspose.slides.charts/idoublechartvalue/).|
|value|Value.<br/>            Read-only [IDoubleChartValue](/python/aspose.slides.charts/idoublechartvalue/).|
...
|label|Label.<br/>            Read-only [IDataLabel](/python/aspose.slides.charts/idatalabel/).|
