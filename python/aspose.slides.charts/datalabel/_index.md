...
type: docs
weight: 310
url: /python/aspose.slides.charts/datalabel/
---
...
|data_label_format|Returns data label format.<br/>            Read-only [IDataLabelFormat](/python/aspose.slides.charts/idatalabelformat/).|
