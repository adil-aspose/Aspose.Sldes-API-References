...
type: docs
weight: 740
url: /python/aspose.slides.charts/idatalabelcollection/
---
...
|**Name**|**Description**|
| :- | :- |
|default_data_label_format|Returns default format of all data labels in the collection.<br/>            Read-only [IDataLabelFormat](/python/aspose.slides.charts/idatalabelformat/).|
...
|parent_series|Returns parent chart series.<br/>            Read-only [IChartSeries](/python/aspose.slides.charts/ichartseries/).|
