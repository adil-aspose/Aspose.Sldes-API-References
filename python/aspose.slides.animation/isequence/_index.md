...
type: docs
weight: 300
url: /python/aspose.slides.animation/isequence/
---
...
|trigger_shape|Returns or sets shape target for INTERACTIVE sequence.<br/>            If sequence is not interactive then returns null.<br/>            Read/write [IShape](/python/aspose.slides/ishape/).|
