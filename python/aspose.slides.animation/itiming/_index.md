...
type: docs
weight: 350
url: /python/aspose.slides.animation/itiming/
---
...
|restart|Specifies if a effect is to restart after complete.<br/>            Read/write [EffectRestartType](/python/aspose.slides.animation/effectrestarttype/).|
...
|trigger_type|Describes trigger type.<br/>            Read/write [EffectTriggerType](/python/aspose.slides.animation/effecttriggertype/).|
