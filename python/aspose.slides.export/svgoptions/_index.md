...
type: docs
weight: 440
url: /python/aspose.slides.export/svgoptions/
---
...
|default|Returns default settings.<br/>            Read-only [SVGOptions](/python/aspose.slides.export/svgoptions/).|
|simple|Returns settings for simpliest and smallest SVG file generation.<br/>            Read-only [SVGOptions](/python/aspose.slides.export/svgoptions/).|
|wysiwyg|Returns settings for most accurate SVG file generation.<br/>            Read-only [SVGOptions](/python/aspose.slides.export/svgoptions/).|
