...
type: docs
weight: 10
url: /python/aspose.slides.export/embedallfontshtmlcontroller/
---
...
|write_all_fonts(generator, presentation)|Write all fonts contained in [Presentation](/python/aspose.slides/presentation/).|
