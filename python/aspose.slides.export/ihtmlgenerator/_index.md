...
type: docs
weight: 150
url: /python/aspose.slides.export/ihtmlgenerator/
---
...
|slide_image_size_unit|Returns a unit in which slide image size is specified.<br/>            Read-only [SvgCoordinateUnit](/python/aspose.slides.export/svgcoordinateunit/).|
